...
const socialTags = (props) => {
    ...
    return [
        ...
        {name: 'twitter:image:src', content: 'https://nao.namifutures.com/images/featured/nao-featured.png'},
        {name: 'twitter:card', content: 'summary_large_image'},
        {name: 'og:title', content: title},
        {name: 'og:url', content: APP_URL + url},
        {name: 'og:image', content: 'https://nao.namifutures.com/images/featured/nao-featured.png'},
