...
const ReTable = memo(({
    ...
    const Wrapper = isNamiV2 ? ReTableWrapperV2 : ReTableWrapper

    return (
        <Wrapper isDark={currentTheme === THEME_MODE.DARK}
...
const ReTableWrapper = styled.div`
  ...
  .rc-table {
    color: ${({ isDark, isNamiV2 }) => isNamiV2 ? colors.namiv2.gray[2] : isDark ? colors.grey4 : colors.darkBlue};
  ...
  .rc-table-content, .rc-table th, .rc-table td {
    border-color: ${({ isDark, isNamiV2 }) => isNamiV2 ? colors.namiv2.black.DEFAULT : isDark ? colors.darkBlue3 : colors.grey4} !important;
    border-right: none;
    border-left: none;
    border-top-width: 0;
  }
  ...
  .rc-table tbody tr td, .rc-table tbody tr th {
    background: ${({ isDark, isNamiV2 }) => isNamiV2 ? colors.namiv2.black.DEFAULT : isDark ? colors.darkBlue2 : colors.white};
  }
  ...
  table {
    ...
    tbody tr:hover td {
      background: ${({ useRowHover, isDark, isNamiV2 }) => useRowHover ? isNamiV2 ? colors.namiv2.black[1] : isDark ? 'rgba(38, 52, 89, 0.5)' : colors.lightTeal : undefined};
      cursor: ${({ useRowHover }) => useRowHover ? 'pointer' : 'normal'} !important;
    }
...
const ReTableWrapperV2 = styled.div`
  ...
  .rc-table-content, .rc-table th, .rc-table td {
    border-color: ${colors.namiv2.black.DEFAULT} !important;
    border-right: none;
    border-left: none;
    border-top-width: 0;
  }
  ...
  .rc-table thead td, .rc-table thead th,
  .rc-table tbody tr td, .rc-table tbody tr th {
    background: ${colors.namiv2.black.DEFAULT};
  }
  ...
  table {
    ...
    tbody tr:hover td {
      background: ${({ useRowHover }) => useRowHover ? colors.namiv2.black[1] : undefined};
      cursor: ${({ useRowHover }) => useRowHover ? 'pointer' : 'normal'} !important;
    }
