        ...
        >
            ...
            >
                <div
                    ...
                    style={{ backgroundColor: hexRgb(colors.darkBlue2, { alpha: 0.6, format: 'rgba' }) }}
                    className={classNames(
                ...
                <div
                    className={classNames(
                        'fixed top-[35%] left-1/2 -translate-x-1/2 -translate-y-1/2 min-w-[280px] min-h-[100px] p-4 z-[99999999] bg-bgPrimary dark:bg-darkBlue-2 rounded-lg dark:drop-shadow-dark',
                        containerClassName
                    )}
                >
