                ...
                <>
                    ...
                    <div className="flex space-x-1 text-txtSecondary dark:text-darkBlue-5 font-semibold truncate overflow-x-auto">
                        <a href={getLoginUrl('sso', 'login')}>
                            <span className="text-teal hover:underline cursor-pointer" dangerouslySetInnerHTML={{ __html: t('common:log_in') }} />
                        </a>
                        <div>{t('common:or')}</div>
                        <a href={getLoginUrl('sso', 'register')}>
                            <span className="text-teal hover:underline cursor-pointer" dangerouslySetInnerHTML={{ __html: t('common:register') }} />
                        </a>
