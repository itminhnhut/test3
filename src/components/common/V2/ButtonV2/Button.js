    ...
    return (
        <button
            className={classNames(
                ...
                {
                    'bg-bgBtnV2 hover:bg-bgBtnV2-pressed active:bg-bgBtnV2-pressed :disabled:bg-bgBtnV2-dark_disabled dark:bg-bgBtnV2 dark:hover:bg-bgBtnV2-dark_pressed dark:active:bg-bgBtnV2-pressed dark:disabled:bg-bgBtnV2-dark_disabled text-white':
                        variants === 'primary',
