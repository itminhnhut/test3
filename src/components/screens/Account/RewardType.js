...
const RewardType = memo(({ data, active, assetConfig, claim, claiming, onClaim }) => {
                ...
                return (
                    <div className="my-4 w-full xl:min-w-[40%] font-medium">
                        <div className="flex items-center">
                            ...
                            <div className="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/2 text-right text-xs md:text-sm xl:text-[16px] lg:pr-6 xl:pr-0 xl:ml-8">
    ...
    const renderButtonGroup = useCallback(() => {
            ...
            if (action?.type === Types.TASK_CTA_TYPE.URL) {
                buttonGroup.push(
                    <RewardButton key={`reward_button_${index}`} title={rewardProps?.title}
                                  ...
                                  componentType="a"
                                  buttonStyles="w-[47%] max-w-[47%] sm:max-w-[120px] xl:min-w-[90px] xl:w-[120px] mr-3"
                    />
                )
            }
        })
        ...
        return (
            <div className="flex items-center lg:justify-end lg:min-w-[200px] xl:min-w-[350px]">
                {!auth ?
