...
import { renderSocials } from 'components/screens/NewReference/mobile/sections/Overview'
...
import { Container, FriendListIcon, NoteIcon } from '../../mobile/sections/Info/RefDetail'
...
const Overview = ({ data, commisionConfig, t, width, user }) => {
    ...
    return (
        <div className='p-20 w-full h-auto' style={{ backgroundImage: `url('${getS3Url('/images/reference/background_desktop.png')}')`, backgroundSize: 'cover' }} >
            ...
            <div className='mt-8 rounded-md bg-teal text-gray-4 flex items-center justify-center px-11 py-2 w-fit cursor-pointer'
                ...
                <div className='w-full absolute bottom-[-220px] flex justify-between bg-white rounded-2xl gap-12 p-8'>
                    <div className="w-full">
                        <div className='w-full flex justify-between items-center'>
                            ...
                            <div>
                                <div className='text-center leading-6 font-medium text-sm text-teal underline cursor-pointer'
                                ...
                                <div key={data.code} className='min-w-[400px] p-4 border-[1px] border-[#a0aec0
                                    ...
                                    <div className="mt-3 font-medium leading-5 flex flex-col gap-2">
                                        ...
                                        <div className="w-full flex justify-between items-center">
                                            ...
                                            >
                                                {data.invitedCount ?? 0} <div className='cursor-pointer'><FriendListIcon /></div>
                                            </div>
                                        </div>
                                        <div className="w-full flex justify-between items-center">
                                            ...
                                            >
                                                {data.note} <div className='cursor-pointer'><NoteIcon /></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
