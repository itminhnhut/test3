...
const Overview = ({
    ...
    return (
        <div className="p-20 w-full h-auto" style={{
            ...
            <div
                className="font-normal text-[20px] leading-[30px] text-gray-6 mt-6 tracking-wide max-w-[800px] mr-[300px]">
                ...
                <div className="w-full absolute bottom-[-220px] flex justify-between bg-white rounded-2xl gap-12 p-8">
                    <div className="w-full">
                        <div className="w-full flex justify-between items-center">
                            ...
                            <div>
                                <div
                                    className="text-center leading-6 font-medium text-sm text-teal underline cursor-pointer"
        ...
        >
            <div className="h-[calc(100%-61px)] px-[10px] pb-6">
                ...
                <div className="px-[10px] overflow-y-auto max-h-[calc(100%-72px)]">
                    {loading ? <IconLoading color={colors.teal}/> : !refs.length ? (
                        <NoData text="No data" className="mt-4"/>
                    ) : (
                        <div className="grid grid-cols-2 gap-4">
                            {refs.map((data, index) => (
                                <div key={data.code} className="min-w-[400px] p-4 border-[1px] border-[#a0aec0
                                    ...
                                    <div className="mt-3 font-medium leading-5 flex flex-col gap-2">
                                        <div className="w-full flex justify-between items-center">
                                            <div
                                                className="text-gray-1 text-xs ">{t('reference:referral.you_friends_get')}</div>
                                        ...
                                        <div className="w-full flex justify-between items-center">
                                            ...
                                            <div
                                                className="text-darkBlue text-sm flex gap-2 justify-end items-center w-fit">
                                                <div
                                                    className="max-w-[140px] truncate">https://nami.exchange/ref/{data.code}</div>
                                                <CopyIcon data={`https://nami.exchange/ref/${data.code}`} size={13.5}
                                                          className="cursor-pointer"/>
                                            </div>
                                        </div>
                                        <div className="w-full flex justify-between items-center">
                                            <div
                                                className="text-gray-1 text-xs ">{t('reference:referral.friends')}</div>
                                            <div
                                            ...
                                            >
                                                {data.invitedCount ?? 0}
                                                <div className="cursor-pointer"><FriendListIcon/></div>
                                            </div>
                                        </div>
                                        <div className="w-full flex justify-between items-center">
                                            ...
                                            >
                                                {data.note}
                                                <div className="cursor-pointer"><NoteIcon/></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="z-20 bg-white w-full flex justify-center mt-6 pb-7 px-4">
                    <div
                        className={classNames('h-11 bg-teal rounded-md w-full flex items-center justify-center text-white font-semibold text-sm cursor-pointer', {
