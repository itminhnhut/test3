        ...
        <>
            ...
            <CollapsibleRefCard title={title[language]} wrapperClassName={isAll ? '!p-0' : ''} isTitle={!isAll} isBlack>
                        ...
                        dataFilter.map((data, index) => {
                            ...
                            return (
                                <div key={index}>
                                                ...
                                                >
                                                    <div className="w-full pt-6 pb-2 px-3 font-semibold text-base text-gray-6">
                                                        <div className="w-full rounded-md border-[1px] border-namiv2-green h-10 flex items-center justify-center">
                                                            <div className="absolute top-[10px] p-1 text-xs font-medium text-gray-1 bg-namiv2-black-2">
                                                                Ref Code
                                                            </div>
                                    ...
                                    <div className="my-3 py-2 rounded-md border-[1px] border-namiv2-black-4 flex text-gray-7">
                                        <div className="w-full text-center border-r-[1px] border-namiv2-black-4 text-sm font-medium">
                                        ...
                                        <div className="flex justify-between w-full">
                                            <div className="flex items-center space-x-2">
                                                ...
                                                <Tooltip id={'direct' + data.code} place="top" effect="solid" arrowColor="#fff">
                                                    <div className="px-6 py-3 text-tiny !bg-namiv2-black-2 min-w-[120px] w-full">
                                            ...
                                            <div className="text-namiv2-green-1 font-semibold">
                ...
                <div className="w-full flex justify-center items-center mt-8">
                    <RePagination total={total} pageSize={limit} current={page} onChange={(page) => setPage(page)} isnamiv2 />
                </div>
            </CollapsibleRefCard>
        </>
    );
            ...
            <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-1 font-medium text-sm leading-6 text-gray-1">
                    ...
                    <DatePicker
                        ...
                        wrapperClassname="bg-namiv2-black-2 text-gray-6 rounded-md"
                        isnamiv2
                    />
                </div>
                <div className="flex flex-col gap-1 font-medium text-sm leading-6 text-gray-1">
