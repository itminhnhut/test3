...
import {
    ...
    FacebookShareButton, RedditIcon, RedditShareButton, TelegramShareButton, TwitterShareButton,
} from 'next-share';
    ...
    return (
        <div className="px-4 py-[60px]" style={{ backgroundImage: "url('/images/reference/background_mobile.png')", backgroundSize: 'cover' }}  >
            ...
            <div className='mt-[38px] flex gap-3 w-full'>
                {(isPartner || !user) ? null : <RefButton className='w-3/5' onClick={() => setShowRegisterPartner(true)}>
