    ...
    return (
        <div className="px-4 py-[60px]" style={{ backgroundImage: "url('/images/reference/background_mobile.png')", backgroundSize: 'cover' }}  >
            ...
            <div className='font-semibold text-sm leading-6 text-gray-6 mt-3'>
                {t('reference:referral.readmore')} <a href={policyLink} target='_blank' ><span className='text-teal underline'>{t('reference:referral.referral_policy')}</span></a>
            </div>
            <div className='mt-[30px]'>
                <RefCard>
                    <div className='pb-2 text-dark-2'>
                ...
                <div className='w-full mt-8 h-11 bg-teal flex items-center justify-center text-sm font-medium text-white rounded-md'
