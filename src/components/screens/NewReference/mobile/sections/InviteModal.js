...
const InviteModal = ({ isShow, onClose, code, isMobile = false }) => {
    ...
    return (
        <PopupModal
            ...
            title={<img src={isMobile ? getS3Url('/images/logo/nami-logo-v2.png') : getS3Url('/images/logo/nami-logo.png')} className="w-auto h-6" />}
        >
            <div className="font-medium text-sm text-white leading-6 flex flex-col gap-4">
                ...
                <div className="w-full h-[333px] flex flex-col items-center text-darkBlue">
                    <div className="text-xs font-medium leading-5 mt-4">{t('reference:referral.referral_code')}</div>
                    <div className="font-semibold text-base leading-8">{code}</div>
