        ...
        <div className="space-y-8 mb-6">
            ...
            !filterRulesData?.length && isSearch ? (
                ...
                [...filterRulesData].slice(0, MOBILE_ROWS_PER_PAGE * page)?.map((rule, i) => {
                    ...
                    return (
                        <>
                            <Tooltip className="p-6 max-w-[247px] text-center" id={`avg_changing_detail_mobile_${rule?.symbol}`} place="right" effect="solid" isV3>
                            ...
                            <div key={rule.symbol + i} className="space-y-4 last:pb-0 pb-4 last:border-0 border-b border-divider dark:border-divider-dark">
                                ...
                                <div className="flex items-center text-sm justify-between">
                                    <div className="text-txtSecondary dark:text-txtSecondary-dark">{t('futures:insurance.min_max_margin_ratio')}</div>
                                    <div className="">
