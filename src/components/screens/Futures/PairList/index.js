...
const FuturesPairList = memo(
    ({ mode, setMode, isAuth, activePairList, onSelectPair = null }) => {
            ...
            let data =
                mode === ''
                    ...
                    : pairConfigs?.filter((i) => {
                          if (mode === 'Starred')
                              return favoritePairs.find((rs) => rs.replace('_', '') === i.symbol);
        ...
        return (
            <div
                ...
                } py-4 min-w-[380px] bg-bgPrimary dark:bg-bgPrimary-dark dark:border dark:border-darkBlue-4 drop-shadow-onlyLight rounded-md`}
            >
