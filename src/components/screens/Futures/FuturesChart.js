...
const FuturesChart = ({ pair, initTimeFrame, isVndcFutures, ordersList, chartKey }) => {
    ...
    return (
        <div className="bg-bgSpotContainer dark:bg-bgSpotContainer-dark h-full dragHandleArea">
            <div className="spot-chart h-full flex flex-col">
                <Chart t={t} chartKey={chartKey} symbol={pair} initTimeFrame={initTimeFrame} ordersList={ordersList} isVndcFutures={isVndcFutures} />
            </div>
        </div>
    );
};
