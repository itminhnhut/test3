...
const TopicsLayout = ({
    ...
    const baseHref =
        mode === 'announcement' ? PATHS.SUPPORT.ANNOUNCEMENT : PATHS.SUPPORT.FAQ
    ...
    const subTopics =
        mainTopic?.subCats?.find((o) => o?.displaySlug === faqCurrentGroup) ||
        false
        ...
        <MaldivesLayout>
            ...
            >
                <div className='flex min-h-[500px]'>
                    ...
                    {lastedArticles &&
                        Array.isArray(lastedArticles) &&
                        lastedArticles.length && (
                            <div
                                style={{
                                    width: COL_WIDTH,
                                    minWidth: COL_WIDTH,
