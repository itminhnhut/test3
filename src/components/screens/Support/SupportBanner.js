...
const SupportBanner = ({ title, ...searchProps }) => {
    const { t } = useTranslation()
    return (
        <div className="support-search-bg">
            <div
                className="container flex flex-col items-center justify-center py-5 px-14 sm:py-8 lg:px-0 lg:flex-row lg:items-center lg:justify-between">
