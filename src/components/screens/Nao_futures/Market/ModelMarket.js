...
import Market from 'components/screens/Nao_futures/Market/Market';
            ...
            >
                <div
                    className={classNames(
                        'flex flex-col absolute top-0 left-0 h-full w-full z-[20] bg-black-800/60 dark:bg-black-800/80',
                    )}
                >
