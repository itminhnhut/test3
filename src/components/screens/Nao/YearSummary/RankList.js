        ...
        <div>
            ...
            {width <= 640 ? (
                                    ...
                                    <div className='flex-1'>
                                        <div className='flex justify-between items-center mb-2'>
                                            <div className='min-w-0'>
                                                ...
                                                <span
                                                    className='text-sm text-txtSecondary dark:text-txtSecondary-dark font-medium break-words'><span className='hidden xsm:inline'>ID: </span>{record.onus_user_id}</span>
                                            </div>
                                            <ImageNao
                                        ...
                                        <div className='space-y-1'>
                                            {information.map(item => {
                                                ...
                                                return <div key={item.valueKey} className='flex justify-between'>
                                                    <span
                                                        className='text-sm text-txtSecondary dark:text-txtSecondary-dark font-medium'>{item.label}</span>
                ...
                <Table loading={false} noItemsMessage={t('nao:contest:no_rank')} dataSource={restUsers}>
                    <Column minWidth={50}
                            className='text-txtSecondary dark:text-txtSecondary-dark font-medium' title={t('nao:contest:rank')}
            ...
            <div className='text-txtSecondary dark:text-txtSecondary-dark font-medium text-sm mt-6'>
