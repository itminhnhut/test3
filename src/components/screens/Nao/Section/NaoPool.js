...
const NaoPool = ({ dataSource, assetNao }) => {
    ...
    return (
        <section id="nao_pool" className="pt-10 sm:pt-20 text-sm sm:text-base">
            ...
            <div className="mt-6 grid sm:grid-cols-2 gap-6">
                ...
                <CardNao className="sm:!min-w-[50%] sm:!px-10 sm:!py-12 sm:!flex-row sm:items-start !min-h-[124px]">
                    <label className="text-txtSecondary dark:text-txtSecondary-dark sm:text-lg">{t('nao:pool:participants')}</label>
                    <div className="sm:text-right flex flex-col gap-1 mt-4 sm:mt-0">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        {listHitory.length > 0 && (
                            <div className="flex space-x-2">
                                <ArrowRight onClick={() => onNavigate(false)} className="rotate-180 cursor-pointer" />
                                <ArrowRight onClick={() => onNavigate(true)} className="cursor-pointer" />
                                {/* <img
