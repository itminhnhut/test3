        ...
        !dataSource?.isNewUser ?
                    ...
                    <CardNao className="divide-nao-line divide-y mt-6">
                        <div className="pb-4">
                            ...
                            <div className="mt-4">
                                ...
                                <div
                                    className="text-xs font-medium leading-6">{formatNumber(data.percent, assetNao?.assetDigit ?? 8)}%
                                </div>
                            </div>
                        </div>
                        <div className="py-4">
            ...
            : <>
                <div className="relative flex flex-col justify-center items-center translate-y-1/2 mt-[-60px]">
                    <img src={getS3Url('/images/nao/ic_nao_coming.png')} className="opacity-[0.4]" alt="" width="100"
                         height="193" width="283"/>
                ...
                <div className={`absolute w-full ${isSmall ? 'bottom-[30px] ' : '-ml-4 bottom-[60px] '}`}>
                    <div className="px-4">
                        <ButtonNao onClick={onShowLock}
                                   className="font-semibold py-3 w-full">{t('nao:pool:stake_now')}</ButtonNao>
                    </div>
                </div>
            </>
    );
