...
const ContestTeamRanks = ({ onShowDetail, previous, contest_id, minVolumeTeam, quoteAsset, lastUpdatedTime, sort, top_ranks_team, showPnl }) => {
    ...
    useEffect(() => {
        ...
        const url = `/${router.locale}/contest${router.query.season ? '/' + router.query.season : ''}?individual=${individual}&team=${
            tab === 'pnl' ? 'pnl' : 'volume'
        }`;
    ...
    return (
        <section className="contest_individual_ranks pt-[4.125rem]">
                                        ...
                                        <div className="text-sm flex-1">
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    ...
                                                    <div className="text-nao-grey font-medium leading-6 cursor-pointer capitalize">
            ...
            {/* <div className='mt-6 text-sm text-nao-grey font-medium leading-6'>{t('nao:contest:last_updated_time')}: {}</div> */}
