                    ...
                    <div className="homepage-first_award___form">
                        ...
                        <div className="homepage-first_award___form___platform">
                            ...
                            <a href={getLoginUrl('sso', 'register')}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 75 75"
                                         fill="none">
                                        <rect x="0.5" y="0.5" width="74" height="74" rx="14.5"
                                              stroke={theme === THEME_MODE.LIGHT ? '#E2E8F0' : colors.darkBlue3}/>
                                        <path
            ...
            <section id="nami_exchange_download_app" className="homepage-app_intro">
                <div className="homepage-app_intro___wrapper mal-container">
                    ...
                    <div className="homepage-app_intro___graphics">
                        <img className="homepage-app_intro___mb_graphics"
                             src={getS3Url(`/images/screen/homepage/mobile_dual_ip_${theme === THEME_MODE.LIGHT ? 'light' : 'dark'}.png`)} alt="Nami Exchange"/>
                        <img className="homepage-app_intro___desktop_graphics"
                             src={getS3Url(`/images/screen/homepage/dual_ip_${theme === THEME_MODE.LIGHT ? 'light' : 'dark'}.png`)} alt="Nami Exchange"/>
                    </div>
                    {theme && theme === THEME_MODE.LIGHT &&
