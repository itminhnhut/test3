                            ...
                            <div className="homepage-first_award__manual__item">
                                ...
                                <div className="flex flex-row items-center">
                                    <Link href="https://www.facebook.com/namifutures">
                                        <a target="_blank">
                                            <img
                                                src={getS3Url('/images/icon/ic_facebook.png')}
                                    ...
                                    <Link href="https://twitter.com/NamiTrade">
                                        <a target="_blank">
                                            <img
                                                src={getS3Url('/images/icon/ic_twitter.png')}
                                                width={width >= 768 ? '52' : '32'}
                                                height={width >= 768 ? '52' : '32'}
                                            />
                                        </a>
                                    ...
                                    <Link href="https://t.me/namitradevn">
                                        <a target="_blank" title="Telegram VN">
                                            <img
                                                src={getS3Url('/images/icon/ic_telegram.png')}
                                                width={width >= 768 ? '52' : '32'}
                                                height={width >= 768 ? '52' : '32'}
                                            />
                                        </a>
                            ...
                            <a href={getLoginUrl('sso', 'register')}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 75 75" fill="none">
                                    ...
                                    <path
                                        ...
                                        fill={theme === THEME_MODE.LIGHT ? '#223050' : colors.gray[4]}
                                    />
                                </svg>
                            </a>
                            <a href={getLoginUrl('sso', 'register')}>
