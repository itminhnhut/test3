        ...
        <>
            <div className="relative">
                <div className="absolute z-0 right-0 top-20 pointer-events-none">
                    <Image src={getS3Url('/images/screen/homepage/right_up.webp')} width="513px" height="313px" />
                </div>
                <div className="absolute z-0 bottom-0 left-0 pointer-events-none">
                    <div className="-mb-20">
                        <Image src={getS3Url('/images/screen/homepage/left_down.webp')} width="511px" height="213px" />
                    </div>
                    <Image src={getS3Url('/images/screen/homepage/ghost_down.webp')} width="389px" height="482px" className="" />
                </div>
                            ...
                            <div className="homepage-trade3step___step___wrapper">
                                <div className="homepage-trade3step___step___item">
                                    <Link href={getLoginUrl('sso', 'register')} passHref>
                                        <div className="homepage-trade3step___step___item___inner">
                                            <Image src={getS3Url(`/images/screen/homepage/create_account_${currentTheme}.webp`)} width="48px" height="48px" />
                                ...
                                <div className="homepage-trade3step___step___item">
                                    <Link href={PATHS.WALLET.EXCHANGE.DEPOSIT} passHref>
                                        <div className="homepage-trade3step___step___item___inner">
                                            <Image src={getS3Url('/images/screen/homepage/fiat_crypto.webp')} width="48px" height="48px" />
                                ...
                                <div className="homepage-trade3step___step___item">
                                    <Link href={PATHS.FUTURES_V2.DEFAULT} passHref>
                                        <div className="homepage-trade3step___step___item___inner">
                                            <Image src={getS3Url(`/images/screen/homepage/start_trading_${currentTheme}.webp`)} width="48px" height="48px" />
