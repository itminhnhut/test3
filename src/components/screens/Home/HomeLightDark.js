...
const SwitchTheme = ({ currentTheme, changeTheme }) => {
    ...
    return (
        <div className={'relative  w-[90px] h-[44px] rounded-full cursor-pointer bg-teal-lightTeal dark:bg-teal '} onClick={() => onChange && onChange()}>
            <div
        ...
        <div className="dark:bg-dark-dark bg-white relative py-[120px]">
            <div className="mal-container px-4 relative">
                <div className="flex justify-center mb-[70px]">
                    <div>
                        <div className="text-sm tooltip-arrow-bottom mb-[30px] justify-center items-center py-3 px-6 inline-flex  rounded-full">Thử ngay </div>
