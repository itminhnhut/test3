            ...
            <div>
                <div className="flex flex-wrap w-full">
                    ...
                    <OrderItem
                        ...
                        value={order?.sl ? formatNumber(order?.sl) : '-'}
                        valueClassName={order?.sl > 0 ? 'text-onus-red' : ''}
                    />
                    <OrderItem
                    ...
                    <OrderItem
                        ...
                        value={order?.tp ? formatNumber(order?.tp) : '-'}
                        valueClassName={order?.tp > 0 ? 'text-onus-green' : ''}
                    />
                </div>
            </div>
            {
