...
import { formatAbbreviateNumber, formatNanNumber, formatPercentage, formatSwapRate, formatTime, getAssetCode, shortHashAddress } from 'redux/actions/utils';
...
const ModalCommissionHistory = ({ onClose, isVisible, t, transaction, id = '', sideCommission }) => {
    ...
    const { money_use, created_at, currency, wallet_type } = transaction;
            ...
            <div>
                ...
                <div className="rounded-xl bg-gray-13 dark:bg-dark-4 p-4">
                    <div className="flex justify-between py-3">
                        ...
                        <TextCopyable className="gap-x-1" showingText={shortHashAddress(id, 10, 6)} text={id} />
                    ...
                    <div className="flex justify-between py-3">
                        ...
                        {loading ? (
                            ...
                            <span className="capitalize">{details?.typeCommission === 'broker' ? t('common:partners') : details?.typeCommission}</span>
                        )}
                    </div>
                </div>
            </div>
