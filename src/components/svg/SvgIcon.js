...
const PartnersIcon = ({ size, color, ...props }) => {
    return (
        <svg {...props} width={size || 24} height={size || 24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M17.78 16.94a1.929 1.929 0 0 1-1.925 1.933 1.92 1.92 0 0 1-1.938 1.927 2.71 2.71 0 0 1-3.85 0l-5.774-5.787 3.85-3.86a2.71 2.71 0 0 1 3.856 0l-2.887 2.89a2.709 2.709 0 0 0 3.85 0l.955-.963 3.863 3.86z"
                fill="#9FF2C5"
            />
            <path d="m19.709 15.013-1.932 1.927-5.78-5.787a2.71 2.71 0 0 1 3.855 0l3.857 3.86z" fill="#5BD891" />
            <path d="M7.512 11.113 3.987 14.64l-1.592-1.6L5.919 9.51l1.593 1.602z" fill="#9FF2C5" />
            <path d="m5.919 9.518 1.593 1.595-3.525 3.527-1.592-1.6 3.524-3.522z" fill="#9FF2C5" />
            <path d="m18.072 9.505-1.591 1.593 3.522 3.526 1.591-1.593-3.522-3.526z" fill="#5BD891" />
            <path d="m13.918 13.08-.963.963a2.71 2.71 0 0 1-3.85 0l2.888-2.89 1.925 1.927z" fill="#0D994E" />
            <path d="M11.995 2.403 9.182 5.219l2.813 2.815 2.813-2.815-2.813-2.816z" fill="#5BD891" />
            <path d="m6.186 4.266-.944.946.944.945.945-.945-.945-.946zM17.704 4.264l-.944.945.944.945.944-.945-.944-.945z" fill="#0D994E" />
        </svg>
    );
};
