...
const PortfolioIconNoColor = ({className, color, size = 24}) => {
    ...
    <svg width={size || 24} height={size || 24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M20.674 11.353h-4.68a.324.324 0 0 1-.316-.25 3.768 3.768 0 0 0-2.794-2.784.324.324 0 0 1-.251-.316V3.324c0-.193.168-.342.36-.322a8.958 8.958 0 0 1 5.414 2.592 8.957 8.957 0 0 1 2.59 5.398.325.325 0 0 1-.323.36zM21 12.93a8.936 8.936 0 0 1-1.939 4.699.325.325 0 0 1-.483.027l-2.62-2.62-.69-.69a.324.324 0 0 1-.045-.401 3.73 3.73 0 0 0 .462-1.122.325.325 0 0 1 .315-.253h4.677c.194 0 .343.168.323.36z" fill={color || defaultColor}/>
        <path d="M16.965 12.57a4.956 4.956 0 0 1-1.007 2.465l-.69-.69a.325.325 0 0 1-.045-.4c.211-.342.369-.72.462-1.122A.324.324 0 0 1 16 12.57h.965z" fill={color || defaultColor} />
        <path d="M17.72 18.516a.325.325 0 0 1-.026.482A8.957 8.957 0 0 1 12.024 21a8.967 8.967 0 0 1-6.38-2.643A8.965 8.965 0 0 1 3 12.017a9.035 9.035 0 0 1 2.643-6.423 8.956 8.956 0 0 1 5.414-2.592c.192-.02.36.13.36.322v4.68a.325.325 0 0 1-.252.315 3.762 3.762 0 0 0-2.896 3.656 3.76 3.76 0 0 0 3.756 3.756c.728 0 1.408-.208 1.984-.568a.325.325 0 0 1 .402.044l3.309 3.309z" fill={color || defaultColor}/>
    </svg>
)}
