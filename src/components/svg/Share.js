...
const SvgShare = ({ color = '#718096', size, fill, style, className, onClick }) => {
    return (
        <div style={style || {}} className={className || {}} onClick={() => onClick && onClick()}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size || '24'} height={size || '24'} viewBox="0 0 24 24" fill={fill || 'none'}>
                ...
                />
                <path d="M15.6 7.2L12.4 4L9.19995 7.2" stroke={color} strokeLinecap="round" strokeLinejoin="round" />
                <path d="M12.4 4V14.4" stroke={color} strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        </div>
    );
};
