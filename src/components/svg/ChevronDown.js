const SvgChevronDown = ({ color = '#8694B3', size=16, fill, style, className, onClick }) => {
    return (
        <svg onClick={onClick} className={`transition ease-in-out rotate-180 ${className}`} width={size} height={size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
