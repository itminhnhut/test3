const Crown = ({
    ...
    return <svg width={size} height={size} style={style} className={className} onClick={onClick} viewBox='0 0 16 16'
        ...
        <g clip-path='url(#lx9ucaahla)'>
            <path d='M14.67 11.159H7.995v-9.01l4.01 5.174 2.663-2.873v6.708z' fill='#fff' />
            <path d='M7.996 2.15 4.062 7.51l-2.74-3.06v6.708h6.674l.312-3.625-.25-5.113-.062-.27z' fill='#fff' />
            <path fill-rule='evenodd' clip-rule='evenodd'
                  ...
                  fill='#B1F5D1' />
            <path fill='#B1F5D1' d='M-1.365 12.54h18.729v1.31H-1.365z' />
        </g>
        <defs>
