const SvgProgress = ({ color = '#47CC85', size, fill = 'none', style, className, onClick }) => {
    return (
        <svg
            width={size || '24'}
            height={size || '24'}
            ...
            onClick={onClick}
        >
            <path d="M12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20Z" fill={color} />
            <path
