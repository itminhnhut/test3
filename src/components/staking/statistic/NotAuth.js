            ...
            <div>
                ...
                <div className="flex space-x-1 text-txtSecondary dark:text-darkBlue-5 truncate overflow-x-auto">
                    <a href={getLoginUrl('sso')}>
                        <span className="text-teal hover:underline cursor-pointer font-semibold" dangerouslySetInnerHTML={{ __html: t('common:sign_in') }} />
                    </a>
                    <div>{t('common:or')}</div>
                    <a href={getLoginUrl('sso', 'register')}>
                        <span className="text-teal hover:underline cursor-pointer font-semibold" dangerouslySetInnerHTML={{ __html: t('common:sign_up') }} />
                    </a>
