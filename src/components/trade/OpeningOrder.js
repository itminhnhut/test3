...
const SpotOrderList = (props) => {
    ...
    const columns = useMemo(() => [
        ...
        },
        {
            ...
            cell: (row) => (
                <button
                    className="w-40 flex items-center text-violet background-transparent  px-3 py-1 text-xs outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 whitespace-nowrap font-medium"
                    type="button"
