...
const TradingInput = ({
    ...
    return (
        <div
            ...
            `relative flex items-center px-[12px] py-2.5 rounded-md  border border-transparent ${onusMode ? 'hover:border-onus-green bg-gray-5 dark:bg-onus-bg2': 'hover:border-base bg-gray-5 dark:bg-darkBlue-3'}`,
