...
const Disclosure = ({ id, itemName, itemAvatar, badge, data, isDefault, actions, handleReloadCategoryList, handleToggleModal, renderPriceData, renderPercentageChange, multiValue }) => {
    ...
    const calculateChange = () => {
        ...
        if (change > 0) {
            return <p className="text-green flex flex-row items-center w-max"><span className="mr-1"><IconValueIncrease /></span> +{change}%</p>;
        }
    ...
    const renderDropdown = () => (
        <div className="mt-4 px-7 pb-2 -mb-5 bg-background rounded-xl -mx-10">
            <Transition
                show={dropDownActive}
                as={Fragment}
                enter="transition ease-out duration-100"
            ...
            >
                <div static="true">
                    <DataTable
                        ...
                        noDataComponent={<TableNoData bgColor="bg-background" width="w-full" />}
