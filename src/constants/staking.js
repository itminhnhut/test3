...
export const FAQ = [
    ...
    },
    {
        ...
        content: {
            isHTMl: true,
            vi: '<ul class="list-disc pl-5"><li class="text-gray-1 dark:text-gray-7">Lãi suất áp dụng trong chương trình Daily Staking là lãi suất kép.</li></ul><p>Ví dụ: Anh Nam nạp vào sàn Nami Exchange 100,000,000 VNDC</p><ul class="list-disc pl-5"><li class="text-gray-1 dark:text-gray-7">Ngày đầu tiên anh Nam nhận được lãi suất 35,000 VNDC</li><li class="text-gray-1 dark:text-gray-7">Ngày thứ hai, hệ thống tính lãi suất dựa trên số dư cộng dồn với lãi thực nhận là: 100,000,000 + 35,000 = 100,035,000. Anh Nam sẽ nhận về lãi suất là 35,012 VNDC</li></ul>',
            en: '<ul class="list-disc pl-5"><li class="text-gray-1 dark:text-gray-7">The interest rate applied in the Daily Staking program is compound interest.</li></ul><p>For example: David stores into Nami Exchange 10,000 USDT</p><ul class="list-disc pl-5"><li class="text-gray-1 dark:text-gray-7">On the first day, David received an interest of 1.6438 USDT</li><li class="text-gray-1 dark:text-gray-7">On the second day, the system calculates interest based on the accumulated balance with the actual received interest: 10,000 + 1.6438 = 10,001.6438 USDT, David will receive an interest of 1.6441 USDT</li></ul>'
        }
    },
    {
        title: {
