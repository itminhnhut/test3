...
export const FEE_TABLE = [
    ...
    { level: 8, vol_30d: '< 50 BTC', andor: 'or', nami_holding: 3e6, maker_taker: '0.05000% / 0.05500%', maker_taker_deducted: '0.03750% / 0.04125%' },
    { level: 9, vol_30d: '< 50 BTC', andor: 'or', nami_holding: 5e6, maker_taker: '0.04000% / 0.04500%', maker_taker_deducted: '0.03000% / 0.03375%' },
]
