...
export const API_GET_QUOTE = API_V3_PREFIX + 'wallet/history/price';
export const API_GET_EARNING_POOLS = API_V3_PREFIX + 'wallet/history/earn/locked-products';
export const API_HISTORY_EARN = API_V3_PREFIX + 'wallet/history/earn/locked-transactions';
export const API_DEPOSIT_EARN = API_V3_PREFIX + 'wallet/history/earn/locked-products';
export const API_EARN_CLAIM_REWARD = API_V3_PREFIX + 'wallet/history/earn/locked-withdraw-rewards';
export const API_EARN_REDEEM = API_V3_PREFIX + 'wallet/history/earn/locked-redeem';
export const API_EARN_TOGGLE_RENEW = API_V3_PREFIX + 'wallet/history/earn/locked-renew';
export const API_EARN_WALLET = API_V3_PREFIX + 'wallet/history/earn/wallet';
...
export const API_GET_PARTNER_STATS_VOLUME_COMMISSION = API_V3_PREFIX + 'wallet/history/dwpartner-statistic';
...
export const API_HISTORY_LOAN_COUNT = API_V3_PREFIX + 'wallet/history/loan/count';
...
export const API_HISTORY_LOAN_ADJUST = API_V3_PREFIX + 'wallet/history/loan/adjust-history';
