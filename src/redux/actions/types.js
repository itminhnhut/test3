...
export const ADD_FUTURES_TICKER_SYMBOL = 'ADD_FUTURES_TICKER_SYMBOL';
export const SET_FUTURES_TICKER_SYMBOL = 'SET_FUTURES_TICKER_SYMBOL';
...
export const SET_NOTIFICATION_UNREAD_COUNT_BASE_ON_STATE = 'SET_NOTIFICATION_UNREAD_COUNT_BASE_ON_STATE';
...
export const GET_PROFILE_PHONE_CHECK_PASS_ID_REQUEST = 'GET_PROFILE_PHONE_CHECK_PASS_ID_REQUEST';
export const GET_PROFILE_PHONE_CHECK_PASS_ID_SUCCESS = 'GET_PROFILE_PHONE_CHECK_PASS_ID_SUCCESS';
export const GET_PROFILE_PHONE_CHECK_PASS_ID_FAILURE = 'GET_PROFILE_PHONE_CHECK_PASS_ID_FAILURE';

export const GET_PROFILE_PASSWORD_CHECK_PASS_ID_REQUEST = 'GET_PROFILE_PASSWORD_CHECK_PASS_ID_REQUEST';
export const GET_PROFILE_PASSWORD_CHECK_PASS_ID_SUCCESS = 'GET_PROFILE_PASSWORD_CHECK_PASS_ID_SUCCESS';
export const GET_PROFILE_PASSWORD_CHECK_PASS_ID_FAILURE = 'GET_PROFILE_PASSWORD_CHECK_PASS_ID_FAILURE';

export const GET_PROFILE_CHECK_PASS_CODE_REQUEST = 'GET_PROFILE_CHECK_PASS_CODE_REQUEST';
export const GET_PROFILE_CHECK_PASS_CODE_SUCCESS = 'GET_PROFILE_CHECK_PASS_CODE_SUCCESS';
export const GET_PROFILE_CHECK_PASS_CODE_FAILURE = 'GET_PROFILE_CHECK_PASS_CODE_FAILURE';
...
export const GET_PROFILE_EMAIL_CHECK_PASS_ID_REQUEST = 'GET_PROFILE_EMAIL_CHECK_PASS_ID_REQUEST';
export const GET_PROFILE_EMAIL_CHECK_PASS_ID_SUCCESS = 'GET_PROFILE_EMAIL_CHECK_PASS_ID_SUCCESS';
export const GET_PROFILE_EMAIL_CHECK_PASS_ID_FAILURE = 'GET_PROFILE_EMAIL_CHECK_PASS_ID_FAILURE';
...
export const GET_ONBOARDING_QUESTIONS_REQUEST = 'GET_ONBOARDING_QUESTIONS_REQUEST';
...
export const SUBMIT_ONBOARDING_QUESTIONS_REQUEST = 'SUBMIT_ONBOARDING_QUESTIONS_REQUEST';
export const SUBMIT_ONBOARDING_QUESTIONS_SUCCESS = 'SUBMIT_ONBOARDING_QUESTIONS_SUCCESS';
export const SUBMIT_ONBOARDING_QUESTIONS_FAILURE = 'SUBMIT_ONBOARDING_QUESTIONS_FAILURE';
...
export const GET_ONBOARDING_PROMOTION_STATUS_REQUEST = 'GET_ONBOARDING_PROMOTION_STATUS_REQUEST';
export const GET_ONBOARDING_PROMOTION_STATUS_SUCCESS = 'GET_ONBOARDING_PROMOTION_STATUS_SUCCESS';
export const GET_ONBOARDING_PROMOTION_STATUS_FAILURE = 'GET_ONBOARDING_PROMOTION_STATUS_FAILURE';
...
export const GET_WITHDRAW_ONCHAIN_CHECK_PASS_ID_REQUEST = 'GET_WITHDRAW_ONCHAIN_CHECK_PASS_ID_REQUEST';
export const GET_WITHDRAW_ONCHAIN_CHECK_PASS_ID_SUCCESS = 'GET_WITHDRAW_ONCHAIN_CHECK_PASS_ID_SUCCESS';
export const GET_WITHDRAW_ONCHAIN_CHECK_PASS_ID_FAILURE = 'GET_WITHDRAW_ONCHAIN_CHECK_PASS_ID_FAILURE';
...
export const SET_OPEN_FUTURES_MARKET_WATCH = 'SET_OPEN_FUTURES_MARKET_WATCH';
...
export const GET_FUTURES_SETTING = 'GET_FUTURES_SETTING';
export const SET_FUTURES_SETTING = 'SET_FUTURES_SETTING';
...
export const SET_PARTNER_MODAL = 'SET_PARTNER_MODAL'
export const RESET_PARTNER_MODAL = 'RESET_PARTNER_MODAL'
export const SET_ACCOUNT_BANK = 'SET_ACCOUNT_BANK';
export const SET_ALLOWED_AMOUNT = 'SET_ALLOWED_AMOUNT';
export const SET_ALLOWED_SUBMIT_ORDER = 'SET_ALLOWED_SUBMIT_ORDER';
export const SET_AUTO_SUGGEST = 'SET_AUTO_SUGGEST';
export const SET_WITHDRAW_DEPOSIT_FEE = 'SET_WITHDRAW_DEPOSIT_FEE'
