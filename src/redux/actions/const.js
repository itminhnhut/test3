...
export const LOCAL_STORAGE_KEY = {
    ...
    LENDING_SEARCH_LIST: 'lendingSearchList'
};
...
export const ApiResultCreateOrder = {
    ...
    ORDER_HAS_BEEN_ACCEPTED_BY_ANOTHER_PARTNER: 'ORDER_HAS_BEEN_ACCEPTED_BY_ANOTHER_PARTNER',
    ORDER_HAS_BEEN_CANCELED: 'ORDER_HAS_BEEN_CANCELED',
    ORDER_HAS_EXPIRED: 'ORDER_HAS_EXPIRED',
    NOT_FOUND_AUTO_PARTNER: 'NOT_FOUND_AUTO_PARTNER',
