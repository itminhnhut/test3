import ScreenPresentation from 'version/maldives/m1/LandingPage/ScreenPresentation'
import AttractiveFeatures from 'version/maldives/m1/LandingPage/AttractiveFeatures'
import PaymentAndKYC from 'version/maldives/m1/LandingPage/PaymentAndKYC'
import ThemingSystem from 'version/maldives/m1/LandingPage/ThemingSystem'
import MadivesLayout from 'components/common/layouts/MaldivesLayout'
import Modal from 'components/common/Modal'
import {default as MobileScreenPresent } from 'version/maldives/m1/LandingPage/ScreenPresent'
...
const LandingPage = () => {
    ...
    return (
        ...
        >
            {renderQrCodeModal()}
            <div className="text-textPrimary bg-get-white">
                {/* Screen Presentation */}
