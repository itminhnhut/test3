    ...
    return (
        <div className="landing_page___screen_presentation">
            <div className="landing_page___screen_presentation____left">
                <div>
                    <div className="landing_page___screen_presentation__item__horizontal">
                        <img src="images/screen/landing-page/ip_sp_left_1.png" alt="Nami Maldives"/>
                    </div>
                    <div className="landing_page___screen_presentation__item__horizontal">
                        <img src="images/screen/landing-page/ip_sp_left_2.png" alt="Nami Maldives"/>
                    </div>
                    <div className="landing_page___screen_presentation__item__horizontal">
                        <img src="images/screen/landing-page/ip_sp_left_3.png" alt="Nami Maldives"/>
                    </div>
                </div>
                <div>
                    <div className="landing_page___screen_presentation__item__vertical">
                        <img src="images/screen/landing-page/ip_sp_left_4.png" alt="Nami Maldives"/>
                    </div>
                    <div className="landing_page___screen_presentation__item__vertical">
                        <img src="images/screen/landing-page/ip_sp_left_5.png" alt="Nami Maldives"/>
                    </div>
                </div>
            </div>
            <div className="landing_page___screen_presentation____center">
                <div>
                    <div className="landing_page___screen_presentation__item__horizontal">
                        <img src="images/screen/landing-page/ip_sp_center_1.png" alt="Nami Maldives"/>
                    </div>
                    <div className="landing_page___screen_presentation__item__horizontal">
                        <img src="images/screen/landing-page/ip_sp_center_2.png" alt="Nami Maldives"/>
                    </div>
                </div>
                <div className="landing_page___screen_presentation___product_intro">
                    <img className="nami_maldives__logo" src="images/screen/landing-page/nami_maldives.png" alt="Nami Maldives"/>
            ...
            <div className="landing_page___screen_presentation____right">
                <div>
                    <div className="landing_page___screen_presentation__item__vertical">
                        <img src="images/screen/landing-page/ip_sp_right_1.png" alt="Nami Maldives"/>
                    </div>
                    <div className="landing_page___screen_presentation__item__vertical">
                        <img src="images/screen/landing-page/ip_sp_right_2.png" alt="Nami Maldives"/>
                    </div>
                </div>
                <div>
                    <div>
                        <div className="landing_page___screen_presentation__item__vertical">
                            <img src="images/screen/landing-page/ip_sp_right_3.png" alt="Nami Maldives"/>
                        </div>
                        <div className="landing_page___screen_presentation__item__vertical">
                            <img src="images/screen/landing-page/ip_sp_right_4.png" alt="Nami Maldives"/>
                        </div>
                    </div>
                    <div className="landing_page___screen_presentation__item__horizontal">
                        <img src="images/screen/landing-page/ip_sp_right_5.png" alt="Nami Maldives"/>
                    </div>
                </div>
            </div>
        </div>
