...
const Terms = () => {
    ...
    const Content = () => {
        return (
            <div
                className={`static max-w-screen-v3 2xl:max-w-screen-xxl m-auto text-txtPrimary bg-white dark:bg-dark dark:text-txtPrimary-dark font-SF-Pro txtPri-2 text-left ${
