...
export const ContainerFluid = styled(Container)`
    background: ${({theme}) => theme.colors.dark7};
`
...
export const ComponentSortItem = styled.div`
    padding: 4px 14px;
    border: 1px solid ${({active, theme}) => active ? theme.colors.mint : '#E5E5E5'};
    border-radius: 3px;
    background: ${({active}) => active ? 'rgba(0, 182, 199, 0.1)' : '#FFFFFF'};
    color: ${({active, theme}) => active ? theme.colors.mint : '#000000'};
    white-space: nowrap;
    margin-right: 16px;
    cursor: pointer;
    user-select: none;
...
export const Pagination = styled.div`
    ...
    i {
        color: ${({theme}) => theme.colors.mint3}
    }
