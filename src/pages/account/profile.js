...
import { API_GET_VIP, API_SET_ASSET_AS_FEE } from 'redux/actions/apis';
        ...
        <AccountLayout>
            <div className='p-6 rounded-xl bg-darkBlue-3 mt-12'>
                <div className='flex'>
                    ...
                    <div className='flex-1 space-y-4'>
                        <span>{t('fee-structure:your_fee_level')} VIP {state.level}</span>
                        <div>
                            <span className='text-txtSecondary mr-2'>Marker</span>
                            <span className='text-xl font-medium'>0.075%</span>
                        </div>
