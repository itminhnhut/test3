...
const SupportAnnouncement = () => {
    ...
    const renderTopics = useCallback(() => {
        if (loading) {
            return (
                <>
                    <div className="w-[48%] sm:w-[49%] lg:w-[32%] mt-3 md:mt-5"><Skeletor className="!w-full"
                                                                                          height={60}/></div>
                    <div className="w-[48%] sm:w-[49%] lg:w-[32%] mt-3 md:mt-5"><Skeletor className="!w-full"
                                                                                          height={60}/></div>
                    <div className="w-[48%] sm:w-[49%] lg:w-[32%] mt-3 md:mt-5"><Skeletor className="!w-full"
    ...
    const renderLastedArticles = useCallback(() => {
        if (loading) {
            return (
                <>
                    <div className="w-full md:w-[48%] md:mr-4 mb-5 lg:mb-8"><Skeletor className="!w-full" height={60}/>
                    </div>
    ...
    useAsync(async () => {
        ...
        const lastedArticles = await getLastedArticles('faq', 10, 1, language)
